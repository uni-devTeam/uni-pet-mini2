...
public interface SignupMapper {
    ...
    @Insert("insert into mypet (user_id, pet_name, pet_birth, pet_gender, pet_kind, pet_neuter, pet_pic, pet_color, pet_weight, pet_trait ) values (#{user_id}, #{pet_name}, #{petBirthday} , #{petGender}, #{petType}, #{doNeutering}, #{petPicture}, #{petColor}, #{petWeight}, #{petChar})")
